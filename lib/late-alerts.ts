...
<div style="font-family:sans-serif;max-width:600px;margin:auto;padding:20px">
  <h2 style="color:#c27a72">Relance : retard de restitution</h2>
  ...
  <table style="width:100%;border-collapse:collapse;margin:16px 0;background:#f8f5f0;border-radius:8px;overflow:hidden">
    ...
    <tr><td style="padding:10px 16px;font-weight:600;border-bottom:1px solid #eee">Jours de retard</td><td style="padding:10px 16px;border-bottom:1px solid #eee;color:#c27a72;font-weight:700">${joursRetard} jour${joursRetard > 1 ? "s" : ""}</td></tr>
    <tr><td style="padding:10px 16px;font-weight:600;border-bottom:1px solid #eee">Majoration appliquée</td><td style="padding:10px 16px;border-bottom:1px solid #eee;color:#c27a72;font-weight:700">${(penalitePercent * 100).toFixed(0)}% → ${penaliteAmount.toFixed(2)} €</td></tr>
    <tr><td style="padding:10px 16px;font-weight:600">Si retard continue (jour+1)</td><td style="padding:10px 16px;color:#c27a72;font-weight:700">${(nextPenalitePercent * 100).toFixed(0)}% → ${nextPenaliteAmount.toFixed(2)} €</td></tr>
  </table>
