...
export async function sendQuoteConfirmation(to: string, quoteNumber: string, recapHtml: string) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto">
      <h2 style="color:#c27a72">Demande de devis reçue</h2>
      <p>Bonjour,</p>
...
export async function sendQuoteStockConfirmed(to: string, quoteNumber: string, recapHtml: string, depositAmount: number) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto">
      <h2 style="color:#c27a72">Stock confirmé</h2>
      <p>Bonjour,</p>
...
export async function sendQuoteStockRefused(to: string, quoteNumber: string, unavailableProducts: string[]) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto">
      <h2 style="color:#c27a72">Indisponibilité de stock</h2>
      <p>Bonjour,</p>
...
export async function sendPaymentConfirmation(to: string, bookingId: string, recapHtml: string) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto">
      <h2 style="color:#c27a72">Réservation confirmée</h2>
...
export async function sendQuoteBalancePaid(to: string, quoteNumber: string, totalTtc: number) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto">
      <h2 style="color:#c27a72">Paiement confirmé</h2>
      <p>Bonjour,</p>
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0">
        ...
        <tr><td style="padding:8px;font-weight:700">Montant réglé</td><td style="padding:8px;text-align:right;font-weight:700;color:#c27a72">${totalTtc.toFixed(2)} €</td></tr>
      </table>
...
export async function sendBalancePaymentLink(to: string, quoteNumber: string, paymentUrl: string, amount: number) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto">
      <h2 style="color:#c27a72">Paiement du solde</h2>
      <p>Bonjour,</p>
...
export async function sendWelcomeEmail(to: string, prenom: string) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto;padding:20px">
      <h2 style="color:#c27a72">Bienvenue ${prenom} !</h2>
      <p>Bonjour ${prenom},</p>
...
export async function sendQuoteExpiryReminder(to: string, quoteNumber: string, clientPrenom: string, lienDevis: string, joursRestants: number) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto;padding:20px">
      <h2 style="color:#c27a72">Votre devis expire bientôt</h2>
...
export async function sendChatbotLead(data: {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto;padding:20px">
      <h2 style="color:#c27a72">Nouveau lead depuis le chatbot</h2>
...
export async function sendCancellationConfirmation(to: string, quoteNumber: string, clientName: string) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto">
      <h2 style="color:#c27a72">Confirmation d'annulation</h2>
...
export async function sendQuoteSignedConfirmation(to: string, quoteNumber: string, clientName: string) {
  ...
  await transport.sendMail({
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:auto">
      <h2 style="color:#c27a72">Devis signé avec succès</h2>
      <p>Bonjour ${clientName},</p>
