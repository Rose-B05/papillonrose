      ...
      <div className="max-w-3xl mx-auto px-5 md:px-10 pt-24 pb-16">
        ...
        <div className="space-y-10 text-sm text-[#2E2E2E]/80 leading-relaxed">
          ...
          <Section num={4} title="Consequences financieres">
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-2xl border border-black/[0.07] dark:border-white/[0.08] overflow-hidden mb-4">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-[#F8F5F0] dark:bg-neutral-900 text-[10px] uppercase tracking-wider text-secondary-text dark:text-white/60">
          ...
          <Section num={7} title="Annulation et remboursement">
            ...
            <div className="bg-[#c27a72]/8 border border-[#c27a72]/20 rounded-xl p-4">
              ...
              <p className="text-xs text-secondary-text dark:text-neutral-300 leading-relaxed">
          ...
          <Section num={8} title="Livraison et retrait">
            ...
            <div className="bg-[#c27a72]/8 border border-[#c27a72]/20 rounded-xl p-4 mb-3">
              <p className="text-sm font-semibold text-[#2E2E2E] dark:text-neutral-100 mb-1">
          ...
          <div className="text-xs text-secondary-text dark:text-white/60 pt-6 border-t border-black/[0.07] dark:border-white/[0.08]">
  ...
  return (
    <section>
      <h2 style={DP} className="text-lg font-semibold text-[#2E2E2E] dark:text-neutral-100 mb-3">
        <span className="text-[#c27a72] dark:text-[#d4968e]">Art. {num}</span> &mdash; {title}
      </h2>
      {children}
    </section>
  )
...
function RiskCard({
  ...
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-xl p-4 border border-black/[0.07] dark:border-white/[0.08] shadow-sm">
      ...
      <p className="text-xs text-secondary-text dark:text-white/70 leading-relaxed">{desc}</p>
    </div>
  )
}
...
function TableRow({
  ...
  return (
    <tr>
      ...
      <td className="px-5 py-3 text-secondary-text dark:text-white/70">{penalty}</td>
    </tr>
  )
}
...
function CancelRow({
  ...
  return (
    <div className="flex items-center justify-between bg-white dark:bg-neutral-800 rounded-xl px-5 py-3 border border-black/[0.07] dark:border-white/[0.08] text-sm">
      ...
      <span className="text-[#c27a72] dark:text-[#d4968e] font-medium">{result}</span>
    </div>
  )
}
