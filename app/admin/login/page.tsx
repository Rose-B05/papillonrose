        ...
        <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-sm border border-black/[0.07] dark:border-white/[0.08] p-8">
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-[#c27a72] dark:bg-[#c27a72] text-white text-sm font-medium rounded-lg hover:bg-[#a86660] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {loading ? (
                    "Envoi…"
                  ) : (
            ...
            <>
              ...
              <div className="space-y-4">
                <div className="flex justify-center gap-2">
                  {otpCode.map((digit, i) => (
                    <input
                      ...
                      className="w-11 h-12 text-center text-lg font-semibold bg-white dark:bg-neutral-800 border border-gray-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#c27a72]/50 focus:border-[#c27a72]"
                      style={{ color: "#1a1a1a", WebkitTextFillColor: "#1a1a1a" }}
                    />
                  ))}
                </div>
                ...
                <button
                  onClick={handleSendOtp}
                  disabled={loading}
                  className="w-full text-sm text-[#c27a72] hover:underline"
                >
                  Renvoyer le code
                </button>
              </div>
          ...
          {view === "forgot-done" && (
            <div className="text-center py-4">
              ...
              <button
                onClick={resetAll}
                className="w-full py-2.5 bg-[#c27a72] dark:bg-[#c27a72] text-white text-sm font-medium rounded-lg hover:bg-[#a86660] transition-colors"
              >
                Se connecter
              </button>
            </div>
