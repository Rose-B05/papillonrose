      ...
      <div className="max-w-5xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="text-secondary-text dark:text-white/60 text-lg mb-2">Aucune location en cours</p>
            <p className="text-sm text-secondary-text dark:text-white/60">Toutes les réservations ont été restituées.</p>
          </div>
        ) : (
                ...
                <div className="space-y-1.5 mb-4">
                  {booking.items.map((item, i) => (
                    <div key={i} className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-secondary-text dark:text-white/60 text-xs">
