...
const STATUT_COLORS: Record<string, string> = {
  ...
  solde_paye: "bg-[#c27a72]/10 dark:bg-[#c27a72]/10 text-[#c27a72] dark:text-[#d4968e]",
}
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3 sm:flex-shrink-0">
                    <span className="text-sm font-semibold text-[#c27a72] dark:text-[#d4968e] whitespace-nowrap">
                    ...
                    {q.statut === "acompte_paye" && (
                      <button
                        ...
                        className="text-xs px-3 py-1.5 bg-[#c27a72] dark:bg-[#c27a72] text-white rounded-lg hover:bg-[#a86660] transition-colors disabled:opacity-50 whitespace-nowrap"
                      >
