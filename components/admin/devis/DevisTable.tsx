          ...
          {devis.map((d) => (
            ...
            >
              ...
              <td className="py-3 px-4">
                ...
                <p className="text-xs text-secondary-text dark:text-white/50">{d.client.email}</p>
              </td>
                ...
                <div className="flex items-center justify-end gap-1">
                  ...
                  {(d.statut === "confirmed" || d.statut === "deposit-pending") && onMarkReturned && (
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-black/[0.05] dark:hover:bg-white/[0.08] text-secondary-text hover:text-purple-600 transition-colors disabled:opacity-50"
