      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-100 dark:bg-neutral-700">
            <History size={16} className="text-secondary-text dark:text-neutral-300" />
          </div>
          <div>
            <h3 className="text-sm font-semibold text-[#2E2E2E] dark:text-neutral-100">Historique</h3>
            <p className="text-xs text-secondary-text dark:text-white/70">{history.length} entrée(s)</p>
          </div>
        </div>
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      <span className="text-xs text-secondary-text dark:text-white/70">
                      ...
                      <span className="text-xs text-secondary-text dark:text-white/70">{entry.user}</span>
                      <span className="text-xs text-secondary-text dark:text-white/60">•</span>
                      <span className="text-xs text-secondary-text dark:text-white/70">{entry.result}</span>
                    </div>
                  </div>
                  {entry.rollbackAvailable && (
                    <button className="text-secondary-text hover:text-[#c27a72] transition-colors ml-2">
                      <RotateCcw size={12} />
                    </button>
                  )}
                </div>
