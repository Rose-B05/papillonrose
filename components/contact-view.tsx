          ...
          <div className="space-y-7">
            {CONTACT_ITEMS.map(({ Icon, label, val, link, note }) => (
              <div key={label} className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[10px] text-secondary-text dark:text-white/60 uppercase tracking-widest mb-0.5">
                    {label}
                  </p>
                  {link ? (
                    <a
                  ...
                  {note && (
                    <p className="text-xs text-secondary-text dark:text-white/60 mt-0.5">{note}</p>
                  )}
                </div>
              </div>
            ))}
