...
export default function AvailabilityCalendar({
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${start || end ? "bg-[#c27a72] dark:bg-[#c27a72] text-white font-bold hover:bg-[#a86660] dark:hover:bg-[#a86660]" : ""}
                  ${inRange && !start && !end ? "bg-[#c27a72]/15 dark:bg-[#c27a72]/15 text-[#2E2E2E] dark:text-neutral-100" : ""}
  ...
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-2xl p-4 shadow-sm border border-black/[0.07] dark:border-white/[0.08]">
      ...
      {dateStart && !dateEnd && (
        <p className="text-[#c27a72] dark:text-[#d4968e] text-[10px] mt-2 text-center font-medium">
      ...
      <div className="flex items-center gap-4 mt-4 pt-3 border-t border-black/[0.05] text-[10px] text-secondary-text dark:text-white/60">
        ...
        <div className="flex items-center gap-1.5">
          <div className="w-3 h-3 rounded bg-[#c27a72]/15 dark:bg-[#c27a72]/15" />
