      ...
      {!isMobile && (
        <>
          <button
            ...
            className="absolute -left-1 md:left-0 top-[42%] -translate-y-1/2 z-20 w-10 h-10 md:w-11 md:h-11 bg-white/80 dark:bg-neutral-900/80 hover:bg-white backdrop-blur-sm rounded-full flex items-center justify-center text-secondary-text dark:text-white/60 hover:text-[#c27a72] dark:hover:text-[#d4968e] shadow-md transition-all"
          ...
          <button
            ...
            className="absolute -right-1 md:right-0 top-[42%] -translate-y-1/2 z-20 w-10 h-10 md:w-11 md:h-11 bg-white/80 dark:bg-neutral-900/80 hover:bg-white backdrop-blur-sm rounded-full flex items-center justify-center text-secondary-text dark:text-white/60 hover:text-[#c27a72] dark:hover:text-[#d4968e] shadow-md transition-all"
            aria-label="Suivant"
          >
